...
| 영역 | 기록 | 한 줄 |
|---|---|---|
| window-control | [ResolutionManager 를 WindowNativeManager 에 합침](../WorkFlow/window-control/2026-09-15/작업내역_window-control_resolutionmanager-merge.md) | 자기 로직 없이 전부 `WindowNativeManager` 호출이었다. 생명주기 3개를 옮기고 클래스 삭제 |
